...
<body class="min-h-screen flex flex-col items-center justify-center p-4 text-center">
    <main class="w-full max-w-6xl mx-auto flex flex-col items-center gap-8 my-8">
        ...
        <div class="flex flex-col items-center">
            ...
            <div id="countdown" class="hero-text font-black text-transparent md:bg-clip-text bg-gradient-to-r from-blue-400 via-teal-300 to-emerald-400 font-mono box-decoration-clone">
